...
inline Vector3<Real> Vector3<Real>::operator/ (Real scalar) const
{
    ...
    {
		result.mTuple[0] = (Real)DBL_MAX;
		result.mTuple[1] = (Real)DBL_MAX;
		result.mTuple[2] = (Real)DBL_MAX;
    }
...
inline Vector3<Real>& Vector3<Real>::operator/= (Real scalar)
{
    ...
    {
        mTuple[0] *= (Real)DBL_MAX;
        mTuple[1] *= (Real)DBL_MAX;
        mTuple[2] *= (Real)DBL_MAX;
    }
    ...
    const
{
    ...
    if ((Real)fabs((double)det) > epsilon)
    {
